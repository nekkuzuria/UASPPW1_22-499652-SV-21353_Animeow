...
<head>
    ...
    <title>My Watchlist - Streaming Anime Movies - Animeow</title>
    ...
    <header class="py-1">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="#" class="mt-4 "><i class="fas fa-heart heart-icon mb-4"></i></a>
                <div class="dropdown">
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row d-flex flex-wrap">
                ...
                if (isset($_GET['query'])) {
                    $query = $_GET['query'];
                    $sql = "SELECT * FROM wishlist INNER JOIN movie ON wishlist.movie_id = movie.movie_id WHERE user_id =" . $_SESSION['user_id'] ."AND movie.title LIKE '%$query%' ";
                } else {
                    $sql = "SELECT * FROM wishlist INNER JOIN movie ON wishlist.movie_id = movie.movie_id WHERE user_id = " . $_SESSION['user_id'] ."";
                }
